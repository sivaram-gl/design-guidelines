...
description: "Great Learning's LEARNER/student-facing app design system (Tamagui monorepo, Material 3 roles, light+dark, Inter). Use whenever building consumer/learner-facing app UI, course screens, or student flows for Great Learning. NOT for internal admin tools (use Jedi) or marketing pages (use GLDS Web)."
---
